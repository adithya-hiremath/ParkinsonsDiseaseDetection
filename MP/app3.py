...
def index():
    ...
    <body>
      <div class="background-wrapper">
        <div class="container">
          <h1>PARKINSON DISEASE DETECTION SYSTEM</h1>
...
def predict():
    if 'file' not in request.files:
        ...
        if file.filename == '':
            ...
            message_type = 'proper'
        elif file and (file.filename.endswith('.wav') or file.filename.endswith('.ogg')):
            ...
            if file.filename.endswith('.ogg'):
                ...
                file_path_wav = file_path.replace('.ogg', '.wav')
            ...
            if prediction == 1:
                ...
                output = "Unable to make prediction"
                message_type = 'proper'
        else:
            output = "Invalid file format. Please upload a .wav or .ogg file."
            message_type = 'proper'
